...
const GUIDE_CHAPTERS: GuideChapter[] = [
  ...
  {
    step: 2,
    title: "Sacred Rituals vs Shadow Habits (The Dopamine Balance)",
    ...
    simpleExplanation: [
      "Sacred Rituals (Deep Work, Exercise, Healthy Eating) give you continuous positive dopamine, granting XP and Gold on every completion.",
      "Shadow Habits (Doomscrolling, Fast Food, Procrastination) represent hazards. Clicking them penalizes your Health (HP) and fuels Guild Boss Rage.",
      "You can view rituals in both the Bounty Board and the Focus Sanctum Gallery!",
    ],
    proTip: "If you resist a shadow impulse, give yourself a mental high five—your avatar stays at full vitality!",
  },
  {
    step: 3,
    title: "Daily Quests & Bounties (Iron Consistency)",
    subtitle: "Build iron consistency without getting overwhelmed.",
    icon: CheckCircle2,
    accentColor: "text-sky-400 bg-sky-500/10 border-sky-500/30",
    simpleExplanation: [
      "Daily Quests are your recurring routines (morning stretches, drinking 2L water, reading 10 pages). They reset each midnight.",
      "Completing daily quests builds Streaks. The higher your streak, the higher your multiplier bonus!",
      "Bounties are flexible one-off missions and projects. You can break big goals down into subtasks with step-by-step checklists.",
    ],
