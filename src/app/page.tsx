    ...
    <ErrorBoundary>
      <div className="min-h-screen flex flex-col bg-[#111418] text-stone-100">
        ...
        <footer className="w-full border-t border-white/[0.08] bg-stone-950/60 backdrop-blur-2xl py-5 px-4 sm:px-8 text-stone-400 mt-12 transition-all">
          <div className="w-full max-w-[1720px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-4">
              <span className="text-stone-500 font-mono text-[11px]">Chronos Arcane Engine v2.4</span>
              <button
                type="button"
