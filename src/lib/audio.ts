/**
 * Procedural 8-bit / Tactile Web Audio Synthesizer
 * Zero audio assets required; synthesized directly via Web Audio API.
 */
...
class SoundEngine {
  ...
  /**
   * Heavy bureaucratic wax stamp thud
   */
  public playStamp() {
    if (this.isMuted) return;
    try {
